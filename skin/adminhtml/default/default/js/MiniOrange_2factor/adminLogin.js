...
$j(document).ready(function() {
    ...
    $j("#cancel").click(function() {
        $j("#loginScreen").css("display", "none");
    });
    ...
    $j("#slide").click(function() {
        ...
        if ($id == 1)
            $j("#QrCode").css("display", "none");
        else if ($id == 2) $j("#softoken").css("display", "none");
        else$j("#forgotPhone").css("display", "none");
    ...
    $j(".goBackPreview").click(function() {
        ...
        else if ($id == 2) $j("#softoken").css("display", "block");
        else$j("#forgotPhone").css("display", "block");
        $j(".goBackPreview[data-slider=" + $id + "]").css("display", "none");
    });
});